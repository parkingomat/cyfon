...
.method public constructor <init>(Li/x;II)V
    .locals 0
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Li/f;
...
.method public synthetic constructor <init>(Li/x;IIILh/h/c/f;)V
    .locals 0
    ...
    .line 7
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Li/x;II)V
...
.method private final getName(I)Li/g;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Li/g;
...
.method private final readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Li/f;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Li/g;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Li/g;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Li/g;Li/g;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Li/g;)Li/g;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Li/g;Li/g;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Li/g;Li/g;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Li/g;Li/g;)V
...
.method public final getAndResetHeaderList()Ljava/util/List;
    ...
    invoke-static {v0}, Lh/e/g;->d(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public final readByteString()Li/g;
    .locals 5
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Li/f;

    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(Li/f;JLi/e;)V
    ...
    invoke-interface {v0, v2, v3}, Li/f;->v(J)Li/g;
