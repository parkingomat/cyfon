...
# instance fields
.field public cachedByte:Ljava/lang/Byte;

.field public chunkSize:I

.field public contentInputStream:Ljava/io/InputStream;

.field public currentChunkLength:I

.field public currentRequest:Lcom/google/api/client/http/HttpRequest;

.field public currentRequestContentBuffer:[B
...
.field public isMediaContentLengthCalculated:Z

.field public final mediaContent:Lcom/google/api/client/http/AbstractInputStreamContent;

.field public mediaContentLength:J

.field public mediaContentLengthStr:Ljava/lang/String;

.field public metadata:Lcom/google/api/client/http/HttpContent;

.field public progressListener:Lcom/google/api/client/googleapis/media/MediaHttpUploaderProgressListener;
...
.field public totalBytesClientSent:J

.field public totalBytesServerReceived:J
...
.method private buildContentChunk()Lcom/google/api/client/googleapis/media/MediaHttpUploader$ContentChunk;
    ...
    invoke-static {v4, v5, v6, v0}, Lcom/google/api/client/util/ByteStreams;->read(Ljava/io/InputStream;[BII)I
