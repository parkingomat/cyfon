...
# instance fields
.field public c:Lc/b/p/i/g;

.field public d:Lc/b/p/i/i;
...
.method public c(Landroid/content/Context;Lc/b/p/i/g;)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lc/b/p/i/g;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->d:Lc/b/p/i/i;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {p1, v0}, Lc/b/p/i/g;->d(Lc/b/p/i/i;)Z

    .line 3
    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lc/b/p/i/g;
...
.method public f(Z)V
    ...
    .line 1
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->d:Lc/b/p/i/i;
    ...
    .line 4
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lc/b/p/i/g;

    invoke-virtual {v2, v1}, Lc/b/p/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    .line 5
    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->d:Lc/b/p/i/i;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->i(Lc/b/p/i/g;Lc/b/p/i/i;)Z
...
.method public i(Lc/b/p/i/g;Lc/b/p/i/i;)Z
    ...
    instance-of v0, p1, Lc/b/p/b;

    if-eqz v0, :cond_0

    .line 2
    check-cast p1, Lc/b/p/b;

    invoke-interface {p1}, Lc/b/p/b;->f()V
    ...
    .line 9
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->d:Lc/b/p/i/i;
    ...
    .line 11
    iput-boolean p1, p2, Lc/b/p/i/i;->C:Z

    .line 12
    iget-object p2, p2, Lc/b/p/i/i;->n:Lc/b/p/i/g;

    invoke-virtual {p2, p1}, Lc/b/p/i/g;->q(Z)V
...
.method public j(Lc/b/p/i/g;Lc/b/p/i/i;)Z
    ...
    invoke-virtual {p2}, Lc/b/p/i/i;->getActionView()Landroid/view/View;
    ...
    .line 8
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->d:Lc/b/p/i/i;
    ...
    invoke-virtual {p2, v0}, Lc/b/p/i/g;->q(Z)V
    ...
    instance-of v0, p2, Lc/b/p/b;

    if-eqz v0, :cond_6

    .line 29
    check-cast p2, Lc/b/p/b;

    invoke-interface {p2}, Lc/b/p/b;->c()V
