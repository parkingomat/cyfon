...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 16
    sget-object v2, Lc/b/j;->SwitchCompat:[I

    .line 17
    new-instance v4, Lc/b/q/v0;
    ...
    invoke-direct {v4, p1, v2}, Lc/b/q/v0;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    .line 19
    sget v2, Lc/b/j;->SwitchCompat_android_thumb:I

    invoke-virtual {v4, v2}, Lc/b/q/v0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/graphics/drawable/Drawable;
    ...
    .line 21
    :cond_0
    sget v2, Lc/b/j;->SwitchCompat_track:I

    invoke-virtual {v4, v2}, Lc/b/q/v0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 23
    :cond_1
    sget v2, Lc/b/j;->SwitchCompat_android_textOn:I

    invoke-virtual {v4, v2}, Lc/b/q/v0;->n(I)Ljava/lang/CharSequence;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->q:Ljava/lang/CharSequence;

    .line 24
    sget v2, Lc/b/j;->SwitchCompat_android_textOff:I

    invoke-virtual {v4, v2}, Lc/b/q/v0;->n(I)Ljava/lang/CharSequence;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->r:Ljava/lang/CharSequence;

    .line 25
    sget v2, Lc/b/j;->SwitchCompat_showText:I

    invoke-virtual {v4, v2, v3}, Lc/b/q/v0;->a(IZ)Z
    ...
    .line 26
    sget v2, Lc/b/j;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v4, v2, v1}, Lc/b/q/v0;->f(II)I
    ...
    .line 27
    sget v2, Lc/b/j;->SwitchCompat_switchMinWidth:I
    ...
    .line 28
    sget v2, Lc/b/j;->SwitchCompat_switchPadding:I
    ...
    .line 29
    sget v2, Lc/b/j;->SwitchCompat_splitTrack:I

    invoke-virtual {v4, v2, v1}, Lc/b/q/v0;->a(IZ)Z
    ...
    .line 30
    sget v2, Lc/b/j;->SwitchCompat_thumbTint:I

    invoke-virtual {v4, v2}, Lc/b/q/v0;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 33
    :cond_2
    sget v2, Lc/b/j;->SwitchCompat_thumbTintMode:I

    const/4 v5, -0x1

    .line 34
    invoke-virtual {v4, v2, v5}, Lc/b/q/v0;->j(II)I

    move-result v2

    .line 35
    invoke-static {v2, v0}, Lc/b/q/c0;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 41
    :cond_5
    sget v2, Lc/b/j;->SwitchCompat_trackTint:I
    ...
    .line 42
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->i:Landroid/content/res/ColorStateList;
    ...
    .line 44
    :cond_6
    sget v2, Lc/b/j;->SwitchCompat_trackTintMode:I
    ...
    .line 48
    iput-object v2, p0, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-boolean v2, p0, Landroidx/appcompat/widget/SwitchCompat;->l:Z
    ...
    .line 52
    :cond_9
    sget v2, Lc/b/j;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v4, v2, v1}, Lc/b/q/v0;->l(II)I
    ...
    .line 53
    sget-object v6, Lc/b/j;->TextAppearance:[I
    ...
    .line 58
    invoke-static {p1, v7}, Lc/b/l/a/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 67
    :cond_c
    sget v6, Lc/b/j;->TextAppearance_android_typeface:I
    ...
    .line 69
    sget v7, Lc/b/j;->TextAppearance_android_textStyle:I
    ...
    .line 83
    :goto_6
    sget v3, Lc/b/j;->TextAppearance_textAllCaps:I
    ...
    .line 85
    new-instance v0, Lc/b/o/a;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lc/b/o/a;-><init>(Landroid/content/Context;)V
    ...
    .line 88
    :cond_16
    new-instance v0, Lc/b/q/w;

    invoke-direct {v0, p0}, Lc/b/q/w;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->N:Lc/b/q/w;

    .line 89
    invoke-virtual {v0, p2, p3}, Lc/b/q/w;->e(Landroid/util/AttributeSet;I)V

    .line 90
    iget-object p2, v4, Lc/b/q/v0;->b:Landroid/content/res/TypedArray;
...
.method private getThumbScrollRange()I
    ...
    .line 5
    invoke-static {v0}, Lc/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 6
    :cond_0
    sget-object v0, Lc/b/q/c0;->c:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 8
    invoke-static {v6}, Lc/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 9
    :cond_0
    sget-object v6, Lc/b/q/c0;->c:Landroid/graphics/Rect;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Lc/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lc/b/q/c0;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
